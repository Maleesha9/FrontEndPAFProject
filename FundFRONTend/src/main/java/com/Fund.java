...
public class Fund {
	...
	public String readFunds() {
		...
		try {
			...
			output = "<table border='1'><tr><th>Researcher Id</th><th>Researcher Name</th>" + "<th>Fund Date</th>"
					+ "<th>Fund Amount</th>" + "<th>Fund Description</th>" + "<th>Update</th><th>Remove</th></tr>";
			...
			while (rs.next()) {
				...
				output += "<td><input name='btnUpdate' " + " type='button' value='Update'></td>"
						+ "<td><form method='post' action='funds.jsp'>" + "<input name='btnRemove' "
						+ " type='submit' value='Remove'>" + "<input name='fundID' type='hidden' " + " value='" + fundID
						+ "'>" + "</form></td></tr>";
			}
